...
# ╔═╡ fa545060-f664-441c-a7ae-fc24efd1d8d9
begin
	using CSV
	using DataFrames
	using Turing
...
# ╔═╡ f5c808cc-b6c7-11ec-1854-91118dbeab74
md"""
# What is Julia?
...
# ╔═╡ 816f734e-c50e-46fe-b20f-71585d03c135
md"""
# Recommended packages

**Caveat**: There are almost always multiple packages that do the same thing in Julia; it is worth doing some digging to see which are still being supported/developed. Check for recent discussions on [the Discourse forum](https://discourse.julialang.org) and recent commits to the package's Github repository. Packages within larger organizations such as [JuliaStats](https://juliastats.org/), [EcoJulia](https://ecojulia.org/), [SciML](https://sciml.ai/), and [JuliaPlots](https://juliaplots.org) are also often good bets.

## Reading in data

- [CSV.jl](https://csv.juliadata.org/stable/) Read CSV files
- [Arrow.jl](https://arrow.juliadata.org) 

## Data manipulation

- [DataFrames.jl]() The equivalent of R's `data.frame`
- [DataFramesMeta.jl](https://juliadata.github.io/DataFramesMeta.jl) Data frame manipulation; equivalent to `dplyr`

## Plotting

- [Plots.jl](https://juliaplots.org) "Base R" style plotting, multiple backend and a recipe system
- [Makie.jl](https://makie.juliaplots.org) More advanced "Base R" style plotting
- [Gadfly.jl](https://gadflyjl.org) Grammar of Graphics style plotting
- [AlgebraOfGraphics.jl](http://juliaplots.org/AlgebraOfGraphics.jl) Grammar of Graphics plotting built on top of Makie.jl

## Statistical modeling

- [GLM.jl](https://juliastats.org/GLM.jl) Linear models
- [MixedModels.jl]() Mixed (hierarchical) models
- [Turing.jl](https://turing.ml) Bayesian modeling (there are many other good options as well)
- [Optim.jl](https://julianlsolvers.github.io/Optim.jl) Function optimization (e.g. for maximum likelihood)

## Interop

- [RCall.jl](https://juliainterop.github.io/RCall.jl) Call R from Julia
- [JuliaCall](https://non-contradiction.github.io/JuliaCall/index.html) Call Julia from R
"""

# ╔═╡ 31980b55-3283-4098-b70a-ffbd10285488
md"""
# Performance

## When should you expect Julia to be faster than e.g. R?

- `for` loops
- Type-stable functions called many times

## When should you expect Julia to be slower (or similar)?

- Linear algebra
- Calling external (e.g. C, Fortran) code
- The first time you call a function (compilation).;,,
"""

# ╔═╡ bace22b9-70d2-41e8-a8d6-11a1dd314a6e


# ╔═╡ 03482e61-8aff-4fdb-820d-8e4f52ec4c04
md"""
# Project management

You can specify a set of packages including versions in the `Project.toml` file in your working directory. This makes it easier to make reproducible analyses.
"""

# ╔═╡ 875bace0-5540-477f-91b9-60639a4b7b5e
md"""
# An example analysis
"""

# ╔═╡ a241cd75-acf5-4e73-9ea0-4140393524ea
?🐇
🐰
🐱

# ╔═╡ 7b8a62b5-f379-43eb-a847-0cf17daeea41
lynxhare = CSV.read(download("https://raw.githubusercontent.com/stan-dev/example-models/master/knitr/lotka-volterra/hudson-bay-lynx-hare.csv"), DataFrame, header = 3)

# ╔═╡ 99034ff7-4dec-46d4-84f7-8dc32552291f
rename!(lynxhare, ["Year", "Lynx", "Hare"])

# ╔═╡ 405644ac-b3f5-4bd5-9dec-99be98233d1a
plot(lynxhare.Year, [lynxhare.Lynx lynxhare.Hare])

# ╔═╡ 10730bbd-723e-4e05-9c4c-e2308fb94770


# ╔═╡ 90fcd7e0-816e-48a8-bd9a-95e7b19bd2ea
md"""
# Other useful packages

- [JuMP.jl](https://jump.dev/) - Mixed Integer Linear Programming (great for SEFS 540!)
- [DifferentialEquations.jl](https://sciml.ai)
"""

# ╔═╡ 75cce329-ca9b-4e90-9034-c110cfa39e28
md"""
# Differences from R

- More external packages
- Fewer users
- Some packages not as mature
- Most users are also developers
"""

# ╔═╡ 2a5c24a5-1d0f-4a52-abab-e54ad62ad7c8
md"""
# Functions

There are at least three ways to define functions:
...
# ╔═╡ 0a5c0c3e-77b6-4422-afb5-e9c13bb47bc9
md"""
# Types

Types are key to working in Julia. All values have a Type.


"""

# ╔═╡ 564822ed-847f-4103-963b-b45e60fd8e4c
y = randn(10)

# ╔═╡ 8cd16fc3-7436-4c1b-a8d3-dc32e9357a35
map(x -> x ^ 2, y)

# ╔═╡ b41cdcaa-8686-420d-af21-c985860bd1de
map(y) do x
	x2 = x + 2
	x2 ^ 2
end

# ╔═╡ acfc93d1-d208-42a2-8eb8-bdf3356f1b2f
y[1] > 0 ? "BIG" : "small"

# ╔═╡ 635ffed3-82a8-4b5b-be99-b351aa4b5d98
md"""
# Control flow
